...
class UnderwaterWSN:
    ...
    def plot_nodes(self, layer_heights):
        ...
        ax.scatter(sink_x_vals, sink_y_vals, sink_z_vals, c='orange', marker='^', label='Sink Nodes')
    ...
    def plot_clusters(self, layer_number=None):
        ...
        for sink in self.sinks:
            ax.scatter(sink.x, sink.y, sink.z, c='orange', marker='^', label=f'Sink {sink.sink_id}')
