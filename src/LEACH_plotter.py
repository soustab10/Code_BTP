...
# todo: add condition to show sink only as olive dot and not both olive and olive
def start(self):
    print('########################################')
    print('############# plot Sensors #############')
    print('########################################')
    ...
    plt.plot(self.alive_sensors, color='olive')
    ...
    plt.plot(self.sum_energy_left_all_nodes, color='olive')
