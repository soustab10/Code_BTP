...
# todo: add condition to show sink only as red dot and not both red and red
def start(self):
    print('########################################')
    print('############# plot Sensors #############')
    print('########################################')
    ...
    plt.plot(self.alive_sensors, color='red')
    ...
    plt.plot(self.sum_energy_left_all_nodes, color='red')
